...
const ItemCard = ({ item, onClick }) => {
  ...
  return (
    <BouncyCard
      onClick={onClick}
      className="group relative w-full aspect-[3/4] cursor-pointer overflow-hidden rounded-3xl bg-surface shadow-lg ring-1 ring-slate-200 transition-shadow hover:shadow-xl"
    >
