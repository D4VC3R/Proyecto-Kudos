...
export const CategoryCard = ({ category }) => {
    return (
        <Link to={`/${category.slug}`}>
            <BouncyCard className="group relative h-80 w-full cursor-pointer overflow-hidden rounded-3xl bg-white shadow-lg ring-1 ring-slate-200 transition-shadow hover:shadow-2xl hover:shadow-blue-500/20">
